...
import { Section, FlexColumnContainer, FlexRowContainer, FlexSection, Title, SmallTitle, Span } from "./common.styles"
  ...
  return (
    <FlexColumnContainer>
      ...
      <FlexSection marginTop={0} column={true} small={true}>
        ...
        { (id == 1) &&
          <React.Fragment>
            <div style={{fontSize:"1.2em"}} dangerouslySetInnerHTML={{ __html: t(`resume:section.${id}.description`) }} />
            <div style={{fontSize:"1.2em"}} dangerouslySetInnerHTML={{ __html: t(`resume:section.${id}.tasks`) }} />
          </React.Fragment>
          }
      </FlexSection>
    </FlexColumnContainer>
  ...
  return (
    <Section>
          ...
          <FlexColumnContainer>
            ...
            <HideOnMobile>
              <Span>
                <div dangerouslySetInnerHTML={{__html: (t("resume:description"))}} />
              </Span>
            </HideOnMobile>}
          </FlexColumnContainer>
          <ExpandableSection
